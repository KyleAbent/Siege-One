...
ModLoader.SetupFileHook( "lua/EvolutionChamber.lua", "lua/EvolutionChamber_Siege21.lua", "post" )
...
--ModLoader.SetupFileHook( "lua/NS2Utility.lua", "lua/NS2Utility_Siege20.lua", "post" )
